    ...
    <>
      <Paragraph
        ...
        ellipsis={{
          rows: 4,
          expandable: true,
          symbol: <Text style={{ fontSize: '10px', color: '#1890ff' }}>展开</Text>
        }}
      >
      ...
      <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
        <Flex align="center">
          <InfoCircleOutlined style={{ marginRight: 6, color: '#666', fontSize: '10p x' }} />
          <Text style={{ fontSize: '10px', color: '#666' }}>事件热度</Text>
        </Flex>
        <Flex align="center">
          <Text style={{ fontSize: '10px', color: '#666' }}>舆论场实时排名</Text>
          <InfoCircleOutlined style={{ marginLeft: 6, color: '#666', fontSize: '10px' }} />
        </Flex>
      </Flex>
      ...
      <Flex align="center" style={{ marginBottom: 4 }}>
        <InfoCircleOutlined style={{ marginRight: 6, color: '#666', fontSize: '10px' }} />
        <Text style={{ fontSize: '10px', color: '#666' }}>事件影响力指数</Text>
      </Flex>
    ...
    return (
      <div style={{ padding: '10px 0' }}>
        <Flex align="center" style={{ marginBottom: 12 }}>
          ...
          <Text strong style={{ fontSize: '12px' }}>事件发展时间线</Text>
        </Flex>
        ...
        <Flex align="flex-start">
          ...
          <div>
            ...
            <Flex align="center" style={{ marginTop: 3 }}>
              <Text style={{ fontSize: '10px', color: '#8c8c8c' }}>{getEventDate(selectedEvent)}</Text>
              <Tag
                color="#f6ffed"
                style={{
                  fontSize: '11px',
          ...
          {isSearching && searchText.trim() !== '' && (
            <Card
              style={{
                ...
                zIndex: 1000,
                padding: 0,
                boxShadow: '0 3px 6px -4px rgba(0, 0, 0, 0.12), 0 6px 12px 0 rgba(0, 0, 0, 0.08)',
                borderRadius: '8px'
              }}
